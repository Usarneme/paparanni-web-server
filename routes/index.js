...
module.exports = function(app) {
  ...
  // GET /upload
  app.get('/upload', mid.requiresLogin, function(req, res, next) {
    if (req.session) {
  ...
  app.post('/upload', mid.requiresLogin, upload, function(req, res, next) {
    if(req.file) {
      var tagArray = [],
          msg = '';
  ...
  // GET /delete photos
  app.get('/delete', mid.requiresLogin, function(req, res, next) {
  ...
  app.post('/delete', mid.requiresLogin, function(req, res, next) {
